    ...
    <section className="py-24 lg:py-32 bg-stone-50">
      <Container>
        <SectionHeading
          ...
          subtitle="Spokojenost zákazníků je pro nás tou nejlepší odměnou."
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-white p-8 rounded-sm shadow-[var(--shadow-soft)] relative"
            >
              {/* Quote mark */}
              ...
              <div className="flex gap-1 mb-4">
                {[...Array(testimonial.rating)].map((_, i) => (
                  <svg
                    key={i}
                    className="w-4 h-4 text-brass-500"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
